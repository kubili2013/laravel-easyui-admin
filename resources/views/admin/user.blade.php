<div  data-options="region:'north'" title="设置查询条件" class="easyui-panel" style="height:80px;">
    <div style="margin: 10px 20px;">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-2012092109942" onclick="queryUser();" style="margin-left:10px;">查询</a>
    </div>
</div>
...
<div id="user-dlg" class="easyui-dialog" style="width:480px;" modal="true"
...
<div id="user-edit-dlg" class="easyui-dialog" style="width:480px;" modal="true"
